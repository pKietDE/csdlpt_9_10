...
go
INSERT INTO TruongHoc_3
SELECT MATR,TENTRUONG,QUOCGIA FROM TruongHoc WHERE QUOCGIA = 'Nauy';
go
...
go
INSERT INTO TruongHoc_4
SELECT MATR,TENTRUONG,QUOCGIA FROM TruongHoc WHERE QUOCGIA = 'Thuy Dien';
...
go
INSERT INTO DuHocSinh_3 
SELECT MADHS,DIACHI,TAICHINH,DONVI FROM DuHocSinh ;
...
go
INSERT INTO NganhHoc_2 
SELECT MANG,SONAM FROM NganhHoc ;
...
go
INSERT INTO DangKy_3
SELECT * FROM DangKyDuHoc WHERE MATR IN (SELECT MATR FROM TruongHoc_3);